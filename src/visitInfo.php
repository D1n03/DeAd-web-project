...
<html lang="en">
  <head>
    ...
    <meta
      name="description"
      content="Please provide information about yourself and any other visitors who may accompany you to visit a prisoner. A visitor could be a family member, lawyer, or psychologist, and they are required to furnish personal details to schedule a visit on the DeAd website."
    />
      ...
      <form action="#" class="details__form-visit" id="visitForm">
        <div class="details__form-visit__labels">
          ...
          <div class="details__form-visit__labels__container">
            <label class="form-text" for="visitDate"
              >The date of the visit*</label
            >
          ...
          <div class="details__form-visit__labels__container">
            <label class="form-text" for="objectData"
              >The items provided by the inmate*</label
            >
          ...
          <div class="details__form-visit__labels__container">
            <label class="form-text" for="prisonerMood"
              >The status of the inmate*</label
            >
            <input class="form-input" required id="prisonerMood" type="text" />
            <p class="validation-error prisonerMood-error">I</p>
          </div>
          <div class="details__form-visit__labels__container">
            <label class="form-text" for="visitNature"
              >The purpose of the visit*</label
            >
            <textarea
              class="form-textarea"
              required
          ...
          <div class="details__form-visit__labels__container">
            <label class="form-text" for="summary"
              >The summary of the discussions*</label
            >
            <textarea
              class="form-textarea"
              required
        ...
        <div class="details__form-visit__buttons">
          <a
            href="visitormain.php"
            class="details__form-visit__buttons__back"
            >Back</a
          >
