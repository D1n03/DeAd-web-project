...
class HistoryAPI extends BaseAPI
{
    ...
    private function getVisits()
    {
        ...
        $stmt = $this->conn->prepare("SELECT visit_id, first_name, last_name, date, visit_start, visit_end, photo FROM visits WHERE person_id = ? AND is_active = 0");
